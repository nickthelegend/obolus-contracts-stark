        ...
        <div className="bg-[#050507]/60 backdrop-blur-md border border-white/5 rounded-2xl p-5 hover:border-[#E44134]/30 transition-all group shadow-lg">
            <div className="flex justify-between items-start mb-6">
                <div className="flex items-center gap-3">
                    <div className={`p-2.5 rounded-xl ${position.side === 'long' ? 'bg-emerald-500/10 text-emerald-400' : 'bg-[#E44134]/10 text-[#E44134]'}`}>
                    ...
                    <div>
                        <div className="flex items-center gap-2">
                            ...
                            <span className={`text-[9px] font-black px-2 py-0.5 rounded-full tracking-widest uppercase ${position.side === 'long' ? 'bg-emerald-500/10 text-emerald-400' : 'bg-[#E44134]/10 text-[#E44134]'
                                }`}>
                ...
                <div className="text-right">
                    <p className={`text-xl font-black font-mono tracking-tighter ${isPositive ? 'text-emerald-400' : 'text-[#E44134]'}`}>
                        {isPositive ? '+' : ''}{position.pnl.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                    </p>
                    <p className={`text-[10px] font-black tracking-widest uppercase ${isPositive ? 'text-emerald-500/60' : 'text-[#E44134]/60'}`}>
            ...
            <div className="grid grid-cols-2 gap-y-4 gap-x-8 mb-6 bg-black/20 p-4 rounded-xl border border-white/5">
                ...
                <div className="space-y-1 text-right">
                    ...
                    <p className="text-[11px] font-black text-[#E44134]/80 font-mono">${position.liqPrice.toLocaleString(undefined, { minimumFractionDigits: 2 })}</p>
                </div>
            </div>
            ...
            <div className="flex gap-2">
                <button
                    onClick={handleClose}
                    className="flex-1 bg-white/5 hover:bg-[#E44134]/10 hover:text-[#E44134] text-neutral-500 py-3 rounded-xl text-[10px] font-black tracking-[0.2em] transition-all border border-white/5 flex items-center justify-center gap-2 uppercase"
                >
                    <X size={14} />
                    Close Position
                </button>
